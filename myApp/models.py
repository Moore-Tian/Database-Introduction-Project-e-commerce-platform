...
class UserInfo(models.Model):
    ...
    user_avatar = models.ImageField(
        upload_to="user_avatar/", null=True, default="user_avatar/default_avatar.jpg"
    )
...
class OrderInfo(models.Model):
    customer_id = models.ForeignKey(
        "UserInfo", related_name="customer", on_delete=models.CASCADE
    )
    business_id = models.ForeignKey(
        "UserInfo", related_name="business", on_delete=models.CASCADE
    )
...
class StarList(models.Model):
    star_customer_id = models.ForeignKey(
        "UserInfo", related_name="star_customer", on_delete=models.CASCADE
    )
    star_business_id = models.ForeignKey(
        "UserInfo", related_name="star_business", on_delete=models.CASCADE
    )
...
class Product(models.Model):
    ...
    product_business = models.ForeignKey(
...
class CheckProduct(models.Model):
    ...
    product_image = models.ImageField(
        upload_to="avatar/", default="avatar/default_pic.jpg"
    )
    product_imageDetail = models.ImageField(
        upload_to="avatar/", default="avatar/default_pic.jpg"
    )
