...
.cart-header-title {
  padding: 16px 32px;
  border-bottom: 1px solid #ffb6c1; /* Light pink border */
...
.cart-content-main {
  ...
  line-height: 60px;
  text-align: center;
  border-bottom: 1px dashed #ffb6c1; /* Light pink dashed border */
  overflow: hidden;
}
...
.cart-control-promotion:hover,
.cart-control-order:hover {
