...
urlpatterns = [
    ...
    path(
        "show_customer_orderProduct_status/",
        OrderView.show_customer_orderProduct_status,
    ),
    path("alterOrderStatus/", OrderView.alterOrderStatus),
    path(
        "show_business_orderProduct_status/",
        OrderView.show_business_orderProduct_status,
    ),
    ...
    re_path(
        r"^media/avatar/(?P<path>.*)$",
        serve,
        {"document_root": os.path.join(settings.MEDIA_ROOT, "avatar/")},
    ),
    re_path(
        r"^media/user_avatar/(?P<path>.*)$",
        serve,
        {"document_root": os.path.join(settings.MEDIA_ROOT, "user_avatar/")},
    ),
    re_path(
        r"^media/comments/(?P<path>.*)$",
        serve,
        {"document_root": os.path.join(settings.MEDIA_ROOT, "user_avatar/")},
    ),
